...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run a local two-party VFL experiment on CelebA.")
...
def main() -> None:
    ...
    print("Running CelebA VFL locally on", device)
    ...
    append_run_summary(
        ...
        notes=(
            f"Task=Smiling, attribute_party=Eyeglasses; seed={args.seed}"
        ),
    )
