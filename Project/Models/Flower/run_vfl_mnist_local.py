...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run a local two-party VFL experiment on MNIST.")
...
def main() -> None:
    ...
    print(f"Running MNIST VFL locally on {device}.")
    print(
    ...
    append_run_summary(
        ...
        notes=(
            f"Two-party vertical split: left_half vs right_half; seed={args.seed}"
        ),
    )
